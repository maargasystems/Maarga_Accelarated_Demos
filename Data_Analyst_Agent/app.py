...
# openrouter_api_key = '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'
...
if uploaded_file is not None and "openrouter_key" in st.session_state:
    # Set the OpenRouter API key from the sidebar
    ...
    if temp_path and columns and df is not None:
        ...
        duckdb_agent = DuckDbAgent(
            ...
            # tools=[PandasTools().model_dump()],  # Use model_dump() for Pydantic v2+
            markdown=True,
